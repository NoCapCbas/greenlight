...
func main() {
  ...
  // database dsn
  flag.StringVar(&cfg.db.dsn, "db-dsn", fmt.Sprintf("postgres://%s:%s@%s/%s?sslmode=disabled", os.Getenv("POSTGRES_USERNAME"), os.Getenv("POSTGRES_PASSWORD"), os.Getenv("POSTGRES_HOST"), os.Getenv("POSTGRES_DATABASE")), "PostgreSQL DSN")
  flag.Parse()
